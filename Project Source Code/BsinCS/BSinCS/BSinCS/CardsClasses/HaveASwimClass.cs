...
namespace HaveASwimClass
{
    public class HaveASwim : Card
    {
        public override string CardName { get { return "Have A Swim"; } }
        ...
        public override string ImageURL { get { return "Have a Swim.png"; } }
